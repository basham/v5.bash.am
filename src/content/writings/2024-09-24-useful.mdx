...
pubDate: 2024-09-24
description: "Identify, research, and write for your audience."
---
...
2. Writing should be usable (upcoming)
...
Writing in digital systems is useful when it is [purposeful](#useful-writing-is-purposeful).

You can [try some activities](#activities-for-useful-writing) to help make your writing more useful.
...
1. A homeowner wants to hang drywall for the first time. This requires knowledge, materials, and tools.
2. They discover Home Depot has an [online guide](https://www.homedepot.com/c/ah/how-to-hang-drywall/9ba683603be9fa5395fab90cbb4826d) to walk through this project with videos and written instructions suitable for do-it-yourself homeowners.
3. They gained knowledge, but the page also lists the materials and tools that they may need and a means to find them in the customer's local store.
...
1. Select a sample situation.
2. Write both sides of the conversation as if it is a text message thread.
3. Write a user journey based on the conversation's text.
4. Repeat as time allows. Add variation by changing:
	- Time, place, and environment
	- Mental or physical impairments of individuals
	- Outcome of the conversation
5. Reflect on what you did and learned.

### Instructions (groups of 2)
