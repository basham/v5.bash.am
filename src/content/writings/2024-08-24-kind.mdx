...
1. Take a situation or conversation from the [activities for useful writing](/2024-08-20/useful#activities-for-useful-writing) as a starting point.
...
A few minutes after the [initial order](/2024-08-20/useful#example-pizza-order), the pizza rep calls the customer:
